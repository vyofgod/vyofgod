...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FF6B6B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><path d="M12 2v20M2 12h20"></path><circle cx="12" cy="12" r="4"></circle></svg> Software developer with **10 years of experience** building backend systems and microservices  
